...
# code from: https://github.com/leoxiaobin/deep-high-resolution-net.pytorch/blob/master/lib/config/models.py
...
POSE_HIGH_RESOLUTION_NET.NUM_JOINTS = 2
...
def get_config():
    return POSE_HIGH_RESOLUTION_NET