...
# implementation from: https://medium.com/@nikdenof/segnet-from-scratch-using-pytorch-3fe9b4527239
...
class SegNet(nn.Module): 
    def __init__(self, in_chns=12, class_num=2, features=64) -> None:
        super(SegNet, self).__init__()

        # Encoder
        self.enc0 = EncoderBlock(in_chns, features)
        ...
        self.dec3 = DecoderBlock(features, class_num, classification=True) # No activation
