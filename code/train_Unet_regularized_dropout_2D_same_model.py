...
def train(args, snapshot_path):
    ...
    dc_hd_loss = losses.DiceLoss(num_classes) # losses.DiceHD95Loss(num_classes, args.alpha_ce)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            writer.add_scalar('loss/loss_ce',
                              loss_ce_1, iter_num)            
            writer.add_scalar('loss/loss_dc',
            ...
            if iter_num > 0 and iter_num % 300 == 0:
                ...
                writer.add_scalar('info/val_mean_dice', performance1[0], iter_num)
                writer.add_scalar('info/mean_hd95', performance1[1], iter_num)
                writer.add_scalar('info/mean_jc', performance1[2], iter_num)
                writer.add_scalar('info/mean_f1', performance1[3], iter_num)
