...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            r_drop_loss = losses.compute_kl_loss(unsupervised_labels, outputs2)
            ...
            loss_su = model_supervised_loss + consistency_weight * r_drop_loss
            loss_uu = consistency_weight * consistency_loss
